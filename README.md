...
**Jev 是 TypeSafe AI 推出的 System One 模型，面向软件中的快速、结构化决策。** 应用把待处理的内容或当前状态，以及明确的问题和判断标准交给 Jev，取得可供程序直接使用的选择、评分或概率，再由业务代码决定下一步动作。[官方介绍](https://docs.typesafe.ai/introduction)
