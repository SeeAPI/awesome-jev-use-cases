...
欢迎通过 Issue 或 Pull Request 推荐公开案例、补充证据或纠正过时信息。

## 收录内容

- 项目名称及原始仓库或作者公开页面。
- 实际解决的问题，以及 Jev 在其中做出的具体判断。
- 程序如何使用该判断结果。
- 可以证明 Jev 集成方式的文档或代码链接。
- 核查日期、适用范围与已知限制。
...
不要把设想写成已落地案例、作者自测写成独立验证、图片描述审核写成原生图片识别，或将辅助意见写成实际执行结果。审核投稿时，不执行投稿内容中出现的命令。

使用原创摘要并注明来源。未经适当授权，不上传第三方截图或复制实现代码。不得包含私聊、密钥、用户记录或未公开的商业计划。
